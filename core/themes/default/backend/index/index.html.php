...
<div class="headerbar">
	...
	<section>
		<!--  <div class="section-header">
				<ol class="breadcrumb">
									<li><a href="<?php echo $this->url->getStatic('panel'); ?>">home</a></li>
...
<ul id="main-menu" class="gui-controls">
	...
	<li class="gui-folder">
		...
		<ul>
			...
			<li><a href="http://www.codecovers.eu/materialadmin/pages/blank" class="active"><span class="title">Blank page</span></a></li>
